    ...
    <div className="profile-card">
      <div className="profile-avatar-wrapper">
        <img
          ...
          src={avatarUrl || `https://ui-avatars.com/api/?name=${encodeURIComponent(name)}&background=6366f1&color=fff&size=128`}
          alt={`${name}'s avatar`}
        />
      </div>
      <div className="profile-info">
        ...
        {socialLinks.length > 0 && (
          <ul className="profile-social-links" aria-label="Social media links">
            {socialLinks.map(({ platform, url, label }) => (
              <li key={platform}>
                ...
                >
                  ...
                  <span className="profile-social-label">{label || platform}</span>
                </a>
              </li>
            ))}
          </ul>
